        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs sm:text-sm font-bold transition ${
              storyboard ? 'tb-pill-ghost' : 'opacity-40 cursor-not-allowed bg-[color-mix(in_srgb,var(--tb-surface-2)_40%,transparent)] border border-white/10 text-[var(--tb-text-muted)]'
            }`}
              ...
              <div className="space-y-1.5">
                ...
                {storyboard.meta.rendering_style && (
                  <div className="flex items-start gap-2">
                    ...
                    <span className="text-sm text-[var(--tb-text)] font-bold flex-1">{storyboard.meta.rendering_style}</span>
                  </div>
                )}
                {storyboard.meta.total_duration_sec > 0 && (
                  <div className="flex items-start gap-2">
                    <span className="text-sm text-[var(--tb-text-muted)] font-medium w-14 pt-0.5">러닝타임</span>
                    <span className="text-sm text-[var(--tb-text)] font-bold flex-1">{storyboard.meta.total_duration_sec}초</span>
                  </div>
                )}
                {storyboard.meta.narrative_arc && (
                  <div className="flex items-start gap-2 pt-1">
                    <span className="text-xs text-[var(--tb-text-muted)] font-medium italic leading-relaxed">“{storyboard.meta.narrative_arc}”</span>
                  </div>
                )}
              </div>
            ) : (
        ...
        <main className="flex-1 min-w-0 flex flex-col md:overflow-hidden bg-[var(--tb-surface)] border border-[var(--tb-border)] rounded-2xl shadow-[0_8px_24px_rgba(0,0,0,0.4)]">
          {toolView === 'frame-extractor' ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center p-10">
              ...
              <h3 className="text-lg font-bold text-[var(--tb-text)] mb-2">이미지 프롬프트가 없습니다</h3>
              ...
              {character && (
                <div className="mt-5 flex items-center gap-2 px-3 py-1.5 rounded-full bg-[var(--tb-surface-2)] border border-[#7c2d12] text-[#fb923c] text-xs font-bold">
                  <User className="w-3.5 h-3.5" />
                    ...
                    <div className="rounded-2xl overflow-hidden border border-[var(--tb-border)] bg-[var(--tb-surface)] shadow-[0_2px_8px_rgba(0,0,0,0.3)]">
                      <div className="px-4 py-3 border-b border-[var(--tb-border)] flex items-center justify-between gap-3 bg-[color-mix(in_srgb,var(--tb-surface-2)_60%,transparent)]">
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 px-2.5 py-1 rounded-full bg-[var(--tb-surface-2)] hover:bg-[#7c2d12] border border-[var(--tb-border)] text-[11px] font-bold text-[color-mix(in_srgb,#f87171_62%,var(--tb-text))] tb-press-soft flex-shrink-0"
                        >
                          ...
                          <div className="flex items-center justify-between mb-2">
                            ...
                            {character.imageUpload && (
                              <button
                                ...
                                className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-[var(--tb-surface-2)] hover:bg-[#7c2d12] border border-[var(--tb-border)] text-[11px] font-bold text-[color-mix(in_srgb,#f87171_62%,var(--tb-text))] tb-press-soft"
                              >
                                <Trash2 className="w-3 h-3" />
                                제거
                              </button>
                        ...
                        <div className="p-4 min-w-0">
                          <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center gap-1.5 min-w-0">
                              ...
                              <span className="text-[11px] uppercase tracking-wider text-[var(--tb-text-muted)] font-bold">캐릭터 프롬프트</span>
                              {character.aspect_ratio && (
                                <span className="text-[11px] px-1.5 py-0.5 rounded-full bg-[var(--tb-surface-2)] text-[#fb923c] font-bold">
                                  {character.aspect_ratio}
                                </span>
                              )}
                            </div>
                          ...
                          <textarea
                            ...
                            className="w-full min-h-[300px] resize-y bg-[var(--tb-surface-2)] border border-[var(--tb-border)] rounded-xl p-2.5 text-[13px] leading-relaxed font-mono text-[var(--tb-text)] focus:outline-none focus:border-[#fb923c] focus:ring-[3px] focus:ring-[#fb923c]/20"
                          />
                        </div>
                      </div>
                    </div>
                          ...
                          <div className="p-4 border-b md:border-b-0 md:border-r border-[var(--tb-border)] space-y-3 min-w-0">
                            <div>
                              ...
                              <textarea
                                ...
                                className="w-full min-h-[90px] resize-y bg-[var(--tb-surface-2)] border border-[var(--tb-border)] rounded-xl p-2.5 text-[13px] leading-relaxed font-mono text-[var(--tb-text)] focus:outline-none focus:border-[#fb923c] focus:ring-[3px] focus:ring-[#fb923c]/20"
                              />
                            </div>
                            <div>
                              <div className="flex items-center justify-between mb-2">
                                <div className="flex items-center gap-1.5 min-w-0">
                                  ...
                                  <span className="text-[11px] px-1.5 py-0.5 rounded-full bg-[var(--tb-surface-2)] text-[#fca5a5] font-bold">
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-3 min-h-0">
              {uploadType === 'character' ? (
                <p className="text-sm text-[var(--tb-text-muted)] leading-relaxed">
                  ...
                  <code className="bg-[var(--tb-surface-2)] px-1.5 py-0.5 rounded text-[#fb923c] font-mono text-[12px] mx-1">meta</code>,
                  <code className="bg-[var(--tb-surface-2)] px-1.5 py-0.5 rounded text-[#fb923c] font-mono text-[12px] mx-1">appearance</code>,
                  <code className="bg-[var(--tb-surface-2)] px-1.5 py-0.5 rounded text-[#fb923c] font-mono text-[12px] mx-1">image_prompt</code>,
                  <code className="bg-[var(--tb-surface-2)] px-1.5 py-0.5 rounded text-[#fb923c] font-mono text-[12px] mx-1">expressions</code>
                  또는 <code className="bg-[var(--tb-surface-2)] px-1.5 py-0.5 rounded text-[#fb923c] font-mono text-[12px]">visual_identity</code>,
                  <code className="bg-[var(--tb-surface-2)] px-1.5 py-0.5 rounded text-[#fb923c] font-mono text-[12px]">consistency_rules</code> 필드 지원.
                </p>
              ) : uploadType === 'video_prompts' ? (
                <p className="text-sm text-[var(--tb-text-muted)] leading-relaxed">
                  <b>video_prompts.json</b> 을 붙여넣으세요. 각 씬의
                  <code className="bg-[var(--tb-surface-2)] px-1.5 py-0.5 rounded text-[#fb923c] font-mono text-[12px] mx-1">scene_id</code>로 기존 씬에 병합되며,
                  <code className="bg-[var(--tb-surface-2)] px-1.5 py-0.5 rounded text-[#fb923c] font-mono text-[12px] mx-1">video_prompt</code>(camera_motion, character_motion, sound_design 등)와
                  <code className="bg-[var(--tb-surface-2)] px-1.5 py-0.5 rounded text-[#fb923c] font-mono text-[12px] mx-1">dialogue</code>가 반영됩니다.
                </p>
              ) : (
                <p className="text-sm text-[var(--tb-text-muted)] leading-relaxed">
                  <b>image_prompts.json</b> 을 붙여넣으세요. <code className="bg-[var(--tb-surface-2)] px-1.5 py-0.5 rounded text-[#fb923c] font-mono text-[12px]">scenes</code> (또는 <code className="bg-[var(--tb-surface-2)] px-1.5 py-0.5 rounded text-[#fb923c] font-mono text-[12px]">image_prompts</code>) 배열이 필요하며, 각 씬은
                  <code className="bg-[var(--tb-surface-2)] px-1.5 py-0.5 rounded text-[#fb923c] font-mono text-[12px] mx-1">scene_id</code>,
                  <code className="bg-[var(--tb-surface-2)] px-1.5 py-0.5 rounded text-[#fb923c] font-mono text-[12px] mx-1">narrative_role</code>(Hook/Setup/Problem/Escalation/Turn/Decision/Action/Obstacle/Reveal/Experience/Peak/CTA),
                  <code className="bg-[var(--tb-surface-2)] px-1.5 py-0.5 rounded text-[#fb923c] font-mono text-[12px] mx-1">background</code>,
                  <code className="bg-[var(--tb-surface-2)] px-1.5 py-0.5 rounded text-[#fb923c] font-mono text-[12px] mx-1">image_prompt</code> 필드를 가질 수 있습니다.
                </p>
              )}
              <textarea
                value={jsonInput}
              ...
              />
              {uploadError && (
                <div className="text-sm text-[#fca5a5] bg-[var(--tb-surface-2)] border border-[#b91c1c] rounded-xl px-3 py-2 font-semibold">
                  {uploadError}
                </div>
              )}
            </div>
