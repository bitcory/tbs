...
const SITE_DESCRIPTION =
  'AI 영상 제작 단계별 커리큘럼 학습실. 마스터 이미지, 1분 영상, 인트로, 멀티영상, 광고 제작, 뮤직영상 마스터까지 ZERO·UP·PRO·MASTER 클래스로 만나보세요.';
...
export const metadata = {
  ...
  icons: {
    icon: [
      { url: '/images/favicon_io/favicon-16x16.png?v=3', sizes: '16x16', type: 'image/png' },
      { url: '/images/favicon_io/favicon-32x32.png?v=3', sizes: '32x32', type: 'image/png' },
      { url: '/images/favicon_io/favicon.ico?v=3', sizes: 'any' },
    ],
    apple: [
      { url: '/images/favicon_io/apple-touch-icon.png?v=3', sizes: '180x180', type: 'image/png' },
    ],
  },
  openGraph: {
    type: 'website',
