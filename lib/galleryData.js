...
export const GALLERY = [
  ...
  },
  {
    ...
    steps: [
      {
        step: "master-monetize",
        label: "MASTER",
        title: "수익화과정",
        media: [
          { type: "youtube", src: "https://youtube.com/shorts/lAeBH-7u-sg", title: "까만 찌든 때가 쓱 지워짐! 추천하는 신발 클리너", portrait: true },
          { type: "youtube", src: "https://youtube.com/shorts/rmryJSjei3Y", title: "주방 기름때 싹 녹이는 파란통 세정티슈 꿀템 🧼", portrait: true },
          { type: "youtube", src: "https://youtube.com/shorts/djvLEfpdi48", title: "깎지 않고 16km를 쓸 수 있는 무한 연필 ✏️", portrait: true },
          { type: "youtube", src: "https://youtube.com/shorts/aqeOWyyMO-Q", title: "빨래 꼬임 스트레스 끝! 엉킴 막아주는 실리콘 세탁볼", portrait: true },
          { type: "youtube", src: "https://youtube.com/shorts/ZBZtgaBecUw", title: "청소천재 브라이언이 욕실 물때 없애는 방법, 물때 제거 욕실 필수템", portrait: true },
          { type: "youtube", src: "https://youtube.com/shorts/0o3m7XB37_I", title: "집에서 끓이는 깊고 얼큰한 김치찌개 | Korean Kimchi Stew Recipe", portrait: true },
          { type: "youtube", src: "https://youtube.com/shorts/6JIq4LvZ-zE", title: "브라이언이 잠들기 전 꼭 하는 3가지… 2번은 의외다😮 #브라이언루틴 #꿀잠템", portrait: true },
          { type: "youtube", src: "https://youtube.com/shorts/CxgvDvPDaLU", title: 'TODAY’S RECIPE "Kimchi Pancake"', portrait: true },
          { type: "youtube", src: "https://youtube.com/shorts/zaqzuhBR4p0", title: 'AI"지아“의 첫번째 외제차 구입 & 데이트 #ai영상제작 #ai인플루언서', portrait: true },
        ],
      },
    ],
  },
