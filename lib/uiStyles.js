...
// Google (white surface + hairline, per Google's brand guidance)
export const googleBtn = {
  ...
  boxShadow:
    "0 10px 22px rgba(15,23,42,0.10), inset 1.5px 1.5px 0.5px 0 rgba(255,255,255,0.7), inset -1px -1px 0.5px 1px rgba(0,0,0,0.03)",
};
...
export const badgeGray = { background: "var(--tb-surface-2)", color: "var(--tb-text-muted)" };
