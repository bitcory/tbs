...
export const CLASS_TYPE_COLOR = {
  ZERO:   { bg: "rgba(59,130,246,0.22)",  fg: "#93c5fd" },
  UP:     { bg: "rgba(249,115,22,0.22)",  fg: "#fb923c" },
  PRO:    { bg: "rgba(129,140,248,0.22)", fg: "#a5b4fc" },
  MASTER: { bg: "rgba(244,63,94,0.22)",   fg: "#fb7185" },
};
...
// "ZERO" / "UP 1-4 · 동물 인터뷰" / "UP 2단계 · 뮤직영상 만들기" / "PRO 1단계 · 시네마틱 5컷 다이얼로그"
